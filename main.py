...
background_image = pygame.image.load("/Users/macos/PycharmProjects/game/venv/background.jpg")  # Update with your background image path
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))

# Load the user-defined robot image (change the path) and increase the size
robot_image = pygame.image.load("/Users/macos/PycharmProjects/game/venv/robot.png")  # Update with your robot image path
...
debris_image = pygame.image.load("/Users/macos/PycharmProjects/game/venv/debris.png")  # Update with your debris image path
...
sound_file_path = '/Users/macos/PycharmProjects/game/venv/emergency-alarm-with-reverb-29431.wav'  # Update with the correct path
